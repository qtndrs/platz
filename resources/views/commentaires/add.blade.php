	...
	resources/views/ressources/show.blade.php
	 ...
	 <div class="post-send">
                    <div id="main-post-send">
                        ...
                        <form id="contact" method="get" action="{{ route('addComment')}}">
                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                            <input id="user" name="user" type="hidden" value="{{$commentaire->user_id}}">
                            ...
                            <div style="text-align:center;"><input type="submit" name="envoi" value="Envoyer" id="bouton"/></div>
                        </form>
                    </div>
                </div>
            </div>
